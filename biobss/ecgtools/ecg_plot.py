...
def _plot_ecg_matplotlib(signals:dict, peaks:dict=None, x_values:ArrayLike=None, x_label:str='Sample', figsize=(18.5, 10.5), show_peaks=True):
    ...
    for signal_name, signal in signals.items():
        ...
        create_signal_plot_matplotlib(ax=axs, signal=signal, x_values=x_values, show_peaks=show_peaks, peaks=peaks[signal_name], plot_title=' ', signal_name=signal_name + ' ECG', x_label=x_label)
...
def _plot_ecg_plotly(signals:dict, peaks:dict=None, x_values:ArrayLike=None, x_label:str='Sample', width=800, height=440, show_peaks=True):
    ...
    for signal_name, signal in signals.items():
        ...
        create_signal_plot_plotly(fig, signal=signal, x_values=x_values, show_peaks=show_peaks, peaks=peaks[signal_name], plot_title=' ',signal_name=signal_name + ' ECG', width=width, height=height, location=(1,1))
