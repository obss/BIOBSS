...
def elim_vlf(sig: ArrayLike, sampling_rate: float) -> ArrayLike:
    ...
    filtered_signal = signal_filter.filter_signal(sig=sig, filter_type=filter_type, N=N, sampling_rate=sampling_rate, f_lower=f1)
...
def elim_vhf(sig: ArrayLike, sampling_rate: float) -> ArrayLike:
    ...
    filtered_signal = signal_filter.filter_signal(sig=sig, filter_type=filter_type, N=N, sampling_rate=sampling_rate, f_upper=f2)
