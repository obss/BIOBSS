...
def test_num_features(load_sample_ppg, ppg_peaks, ppg_onsets, ppg_fiducials):
    ...
    features_cycles = from_cycles(sig=sig, peaks_locs=ppg_peaks, troughs_locs=ppg_onsets, sampling_rate=fs,feature_types=['Time','Stat'],fiducials=ppg_fiducials,prefix='ppg')
